...
public class RobotContainer {
    ...
    public final CommandHangSubsystem hangSubsystem = new CommandHangSubsystem();
    public final MotorOnCommand motorOncommand = new MotorOnCommand(hangSubsystem);

    // public final CommandHangSubsystem hang = 
    ...
    private void configureBindings() {
        ...
        joystick.start().and(joystick.a()).whileTrue(motorOncommand);

        // joystick.start().and(joystick.a()).whileTrue(hang.setSpeed(0.5));
